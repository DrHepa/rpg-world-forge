...
export type WorldForgeStudioCreationEvidenceProtocolV4 = Request | Response | ErrorEnvelope;
export type Request = {
...
export type WorldForgeStudioCreationJobV9 = {
  ...
  format_version: 1 | 2 | 3 | 4 | 5 | 6 | 7 | 8 | 9;
  /**
   * This interface was referenced by `undefined`'s JSON-Schema
   * via the `definition` "entityId".
   */
  ...
  progress:
    ...
    | "canceled"
    | "orphaned";
  result: ResultV1V2 | ResultV3 | null | ResultV5 | ResultV6 | ResultV7 | ResultV8 | ResultV9;
  error: Error | null;
  /**
   * This interface was referenced by `undefined`'s JSON-Schema
   * via the `definition` "timestamp".
...
export interface CreationPreviewOpenParams {
  workspace_id: WorkspaceId;
  expected_root_generation: number;
  expected_source_revision: Sha256;
  expected_workflow_status_hash: NullableSha256;
...
export interface OutputGrantResult {
  grant: WorldForgeStudioCreationOutputGrantV5;
}
/**
 * This interface was referenced by `undefined`'s JSON-Schema
...
export interface OutputGrantListResult {
  ...
  grants:
    ...
    | [WorldForgeStudioCreationOutputGrantV5, WorldForgeStudioCreationOutputGrantV5]
    | [
        WorldForgeStudioCreationOutputGrantV5,
        WorldForgeStudioCreationOutputGrantV5,
        WorldForgeStudioCreationOutputGrantV5,
...
export interface JobResult {
  job: WorldForgeStudioCreationJobV9;
}
/**
 * This interface was referenced by `undefined`'s JSON-Schema
...
export interface JobListResult {
  ...
  jobs:
    ...
    | [WorldForgeStudioCreationJobV9, WorldForgeStudioCreationJobV9]
    | [WorldForgeStudioCreationJobV9, WorldForgeStudioCreationJobV9, WorldForgeStudioCreationJobV9]
    | [
        WorldForgeStudioCreationJobV9,
        WorldForgeStudioCreationJobV9,
        WorldForgeStudioCreationJobV9,
...
export interface CreationPreviewOpenResult {
  preview: WorldForgeStudioCreationPreviewV1;
}
/**
 * This interface was referenced by `undefined`'s JSON-Schema
